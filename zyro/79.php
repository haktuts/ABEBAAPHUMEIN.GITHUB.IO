...
<head>
	...
	<base href="{{base_url}}" />
		...
		<meta name="description" content="top list of cydia tweaks" />
	<meta name="keywords" content="top list of cydia tweaks" />
	...
	<link href="css/79.css?ts=1433839386" rel="stylesheet" type="text/css" />
...
<p class="wb-stl-normal"> </p>
</div><div id="wb_element_instance431" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance431");
...
<div id="wb_element_instance429" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance432" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
