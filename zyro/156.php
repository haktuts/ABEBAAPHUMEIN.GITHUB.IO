...
<head>
	...
	<link href="css/156.css?ts=1433839389" rel="stylesheet" type="text/css" />
...
<div id="wb_element_instance1412" class="wb_element" style=" overflow: hidden;"><script id="airpushScript" type="text/javascript" src="//ab.airpush.com/apportal/client/airpush.js?siteid=263411&amp;testmode=0&amp;banner360=1&amp;banner=slot1&amp;placementid=0&amp;tp=0">
            ...
            body{
                ...
                padding: 0;
                    ...
                    </tr></tbody></table></div><div id="wb_element_instance1413" class="wb_element"><div style="font-size: 1px; overflow: hidden; line-height: 1px; padding: 0; background: transparent; float: none; position: relative; margin: 1px 0 0 0; width: 100%; height: 1px; left: 0; top: 50%; border-top: 1px solid #303030;"></div></div><div id="wb_element_instance1415" class="wb_element" style=" line-height: normal;"><h1 class="wb-stl-heading1">NETWORK MANGEMENT</h1>

<p class="wb-stl-normal"><br>
 </p>

<p class="wb-stl-normal"><span style="color:#f10631;">ifconfig</span><br>
Show the ip address eth0</p>

<p class="wb-stl-normal"><br>
 </p>

<p class="wb-stl-normal"><span style="color:#f10631;">iwconfig</span></p>
...
<h2 class="wb-stl-heading2"><strong>SHARE FILE FROM WINDOWS TO LINUX.</strong></h2>
...
<p class="wb-stl-normal">e.g. <span style="color:#f10631;">smbclient //HAKTUTS/Ethicalhacking -U hak</span><br><br>
 </p>

<h2 class="wb-stl-heading2"><strong>SSH-Secure Shell</strong></h2>

<p class="wb-stl-normal"> </p>

<p class="wb-stl-normal"><br><span style="color:#f10631;">ssh user@host</span> <br>
...
<h3 class="wb-stl-heading3"><strong>FTP-File Transfer Protocol</strong></h3>
...
<p class="wb-stl-normal"><br>
 </p>
</div><div id="wb_element_instance1416" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance1416");
...
<div id="wb_element_instance1414" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance1417" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
