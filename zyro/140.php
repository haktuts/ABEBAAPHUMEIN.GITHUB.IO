...
<head>
	...
	<base href="{{base_url}}" />
		...
		<meta name="description" content="Use your Android Phone Camera  as WebCam" />
	<meta name="keywords" content="Use your Android Phone Camera as WebCam" />
	...
	<link href="css/140.css?ts=1433839388" rel="stylesheet" type="text/css" />
...
<div id="wb_element_instance1028" class="wb_element" style=" overflow: hidden;"><script id="airpushScript" type="text/javascript" src="//ab.airpush.com/apportal/client/airpush.js?siteid=263411&amp;testmode=0&amp;banner360=1&amp;banner=slot1&amp;placementid=0&amp;tp=0">
            ...
            body{
                ...
                padding: 0;
                    ...
                    </tr></tbody></table></div><div id="wb_element_instance1029" class="wb_element"><div style="font-size: 1px; overflow: hidden; line-height: 1px; padding: 0; background: transparent; float: none; position: relative; margin: 1px 0 0 0; width: 100%; height: 1px; left: 0; top: 50%; border-top: 1px solid #303030;"></div></div><div id="wb_element_instance1031" class="wb_element" style=" line-height: normal;"><h1 class="wb-stl-heading1">USE YOUR ANDROID PHONE AS WEBCAM</h1>

<p> </p>

<p class="wb-stl-normal"> </p>

<h5 class="wb-stl-subtitle"><span style="color:#f10930;">I. Use your android phone as webcam using Wifi.</span></h5>
...
<h5 class="wb-stl-subtitle"><span style="color:#f10930;">II. Use your android phone as webcam using USB.</span></h5>
...
<p> </p>
</div><div id="wb_element_instance1032" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance1032");
...
<div id="wb_element_instance1030" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance1033" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
