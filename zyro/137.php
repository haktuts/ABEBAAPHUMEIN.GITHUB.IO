...
<head>
	...
	<base href="{{base_url}}" />
		...
		<meta name="description" content="Firefox Addons for Pentester and ethical hackers" />
	<meta name="keywords" content="Firefox Addons for Pentester and ethical hackers" />
	...
	<link href="css/137.css?ts=1433839388" rel="stylesheet" type="text/css" />
...
<div id="wb_element_instance988" class="wb_element" style=" overflow: hidden;"><script id="airpushScript" type="text/javascript" src="//ab.airpush.com/apportal/client/airpush.js?siteid=263411&amp;testmode=0&amp;banner360=1&amp;banner=slot1&amp;placementid=0&amp;tp=0">
            ...
            body{
                ...
                padding: 0;
                    ...
                    </tr></tbody></table></div><div id="wb_element_instance989" class="wb_element"><div style="font-size: 1px; overflow: hidden; line-height: 1px; padding: 0; background: transparent; float: none; position: relative; margin: 1px 0 0 0; width: 100%; height: 1px; left: 0; top: 50%; border-top: 1px solid #303030;"></div></div><div id="wb_element_instance991" class="wb_element" style=" line-height: normal;"><h1 class="wb-stl-heading1">Firefox AddOns For Pentester</h1>

<p> </p>

<p class="wb-stl-normal">1.Greasemonkey</p>

<p class="wb-stl-normal">Customize the way a web page displays or behaves, by using small bits of JavaScript.</p>
...
Snort IDS Rule Search is another search add-on for Firefox. It lets users search for Snort IDS rules on the snort.org website. Snort is the most widely deployed IDS/IPS technology worldwide. It’s an open source network Intrusion prevention and detection system with more than 400,000 users</p>

<p class="wb-stl-normal"> </p>

<p class="wb-stl-normal"> </p>
</div><div id="wb_element_instance992" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance992");
...
<div id="wb_element_instance990" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance993" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
