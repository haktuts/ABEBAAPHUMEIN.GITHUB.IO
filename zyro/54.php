...
<head>
	...
	<title>Concept Of MAC Address</title>
	<base href="{{base_url}}" />
	...
	<link href="css/54.css?ts=1433839386" rel="stylesheet" type="text/css" />
...
<p class="wb-stl-normal"> </p>
</div><div id="wb_element_instance202" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance202");
...
<div id="wb_element_instance200" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance203" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
