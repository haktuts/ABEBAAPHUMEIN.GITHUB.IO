...
<head>
	...
	<link href="css/99.css?ts=1433839387" rel="stylesheet" type="text/css" />
...
<div id="wb_element_instance636" class="wb_element" style=" overflow: hidden;"><script id="airpushScript" type="text/javascript" src="//ab.airpush.com/apportal/client/airpush.js?siteid=263411&amp;testmode=0&amp;banner360=1&amp;banner=slot1&amp;placementid=0&amp;tp=0">
            ...
            body{
                ...
                padding: 0;
                    ...
                    </tr></tbody></table></div><div id="wb_element_instance637" class="wb_element"><div style="font-size: 1px; overflow: hidden; line-height: 1px; padding: 0; background: transparent; float: none; position: relative; margin: 1px 0 0 0; width: 100%; height: 1px; left: 0; top: 50%; border-top: 1px solid #303030;"></div></div><div id="wb_element_instance639" class="wb_element" style=" line-height: normal;"><h2 class="wb-stl-heading2">How to trace the ip address of victim.</h2>
...
<p> </p>
</div><div id="wb_element_instance640" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance640");
...
<div id="wb_element_instance638" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance641" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
